<select name=<%= datePrefix + "Month"+ dateSuffix %> onChange="ajaxAttributeUpdate(this.form, <%= "'"+datePrefix+"'" %>,<%=attributeDef.getType()%>, '<%=ajaxParms%>', '<%=attributeProperty%>'); setDays( this.form, <%= "'"+datePrefix+"'" %>, <%= theDay %>, <%= "'"+dateSuffix+"'" %>  );">
...
<select name=<%= datePrefix + "Day"  + dateSuffix %> onChange="ajaxAttributeUpdate(this.form, <%= "'"+datePrefix+"'" %>,<%=attributeDef.getType()%>, '<%=ajaxParms%>', '<%=attributeProperty%>'); setDays( this.form, <%= "'"+datePrefix+"'" %>, <%= theDay %>, <%= "'"+dateSuffix+"'" %>  );">
   <%   numDays = 31;
...
<select name=<%= datePrefix + "Year" + dateSuffix %> onChange="ajaxAttributeUpdate(this.form, <%= "'"+datePrefix+"'" %>,<%=attributeDef.getType()%>, '<%=ajaxParms%>', '<%=attributeProperty%>'); setDays( this.form, <%= "'"+datePrefix+"'" %>, <%= theDay %>, <%= "'"+dateSuffix+"'" %>  );">
