<%
   ...
   wgbeDataAccessCtrl.blogPostCount   = 6;
   ...
   else // this is not a search
   {
      ...
      wgbeDataAccessCtrl.getCategoryCtrl().getSpotlightProfileCtrl().profileSetSize  = 12;
   ...
   {
      wgbeDataAccessCtrl.getCategoryCtrl().getProfileCtrl().randomStart   = true;
      wgbeDataAccessCtrl.getCategoryCtrl().getProfileCtrl().profileSetSize  = 99999;
      wgbeDataAccessCtrl.getCategoryCtrl().getProfileCtrl().profileSetId  = 1;
   }
