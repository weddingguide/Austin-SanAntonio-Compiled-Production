<%
    wgbeDataAccessCtrl.getCategoryCtrl().getProfileCtrl().singleProfile = jspUtils.getIntParm( "businessEntityId" );

    wgbeDataAccessCtrl.inclCategories  = true;

    wgbeDataAccessCtrl.getCategoryCtrl().maxCategories  = 1;
