			<div class="bridal-blog">
				...
				<a href="#"><img src="img/arrow_pink.png" /> Submit a Love Story!</a></div>
				...
				<p><x:set var="blogAbstract" select="string($blogThread/abstract)"/><c:out value="${blogAbstract}" escapeXml="false"/>[<a href="#">continue</a>]</p>
