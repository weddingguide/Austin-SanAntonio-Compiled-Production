...
<%@ include file="dataaccess/planningTools_dataaccess_incl.jsp" %>
...
<div id="container">
   ...
   <div id="content" class="weddingGuide">
   	<div class="wedding-guide">
    	<%@ include file="incl/weddingGuide_incl.jsp" %>
    </div>
